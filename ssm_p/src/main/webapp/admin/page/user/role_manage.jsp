...
<div class="layui-btn-group">
    <shiro:hasPermission name="user:manage7">
	<a class="layui-btn layui-btn-xs" lay-event="edit">修改</a>
    </shiro:hasPermission>
    <shiro:hasPermission name="user:manage8">
	<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="set_Role">设置权限</a>
    </shiro:hasPermission>
</div>
</script>
