...
<div class="layui-btn-group">
	...
	<a class="layui-btn layui-btn-xs" lay-event="edit">提交申请材料</a>
</div>
</script>
...
<script>
		layui.use([ 'laydate', 'laypage', 'layer', 'table', 'carousel',
			...
			, element = layui.element; //元素操作
			  table.render({
			    elem: '#table'
			    ,url: 'admin/apply/car/list?sub=nul&state=nul'
			    ,height: 'full-60'
			    ,even:true
			   ,cols: [[
			      {checkbox: true, fixed: true}
			      ,{field:'fileId', title: '档案编号', width:150,sort:true}
			      ,{field:'storageTime', title: '入场时间', width:150 ,sort:true}
			      ,{field:'storageName', title: '入场登记人', width:100 }
			      ,{field:'carId', title: '车牌号码', width:100}
			      ,{field:'registrationName', title: '登记人', width:100}
			      ,{field:'createDateTime', title: '创建时间', width:150,sort:true }
			      ...
			      ,{field:'sub', title: '申请状态', width:100 }
