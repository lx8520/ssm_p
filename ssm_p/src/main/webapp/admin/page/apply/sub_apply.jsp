...
function edit(id){
	...
	layer.open({
	  ...
	  shade: 0.8,
	  area: [w+'px', h+'px'],
	  content: 'houtai/apply/car/manage/edit?id='+id, //iframe的url
	  end: function () {
          location.reload();
      }
	});
...
function look(id){
	...
	layer.open({
		  ...
		  shade: 0.8,
		  area: [w+'px', h+'px'],
		  content: 'houtai/apply/sub/manage/look?id='+id, //iframe的url
		  end: function () {
              location.reload();
          }
	}); 
...
<div class="layui-btn-group">
	<a class="layui-btn layui-btn-xs" lay-event="look">查看进度</a>
</div>
</script>
...
<script type="text/html" id="format_sub">
  {{#  if(d.sub == null){ }}
     	未提交申请
  {{#  } else if(d.sub == '0') { }}
		已提交申请，待审批
...
<script>
		layui.use([ 'laydate', 'laypage', 'layer', 'table', 'carousel',
			...
			, element = layui.element; //元素操作
			  table.render({
			    elem: '#table'
			    ,url: 'admin/apply/sub/list?sub=0&state=0'
			    ,height: 'full-60'
			    ,even:true
			   ,cols: [[
			      {checkbox: true, fixed: true}
			      ,{field:'fileId', title: '档案编号', width:150,sort:true}
			      ,{field:'registrationName', title: '登记人', width:100}
			      ,{field:'subDateTime', title: '提交时间', width:150,sort:true }
			      ,{field:'carState', title: '车辆状态', width:100,templet:'#format_carState' }
			      ,{field:'sub', title: '申请状态', width:100,templet:'#format_sub' }
